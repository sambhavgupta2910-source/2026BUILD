...
function bindPublicSite() {
  ...
  document.querySelector("#public-rfq").addEventListener("click", () => {
    showToast("Sample RFQ captured. In production this routes to the structured intake queue.");
  });

  document.querySelector("#inventory-search").addEventListener("click", () => {
    showToast("Inventory search prepared. Production would return availability, condition, lead time, and RFQ options.");
  });
}
