...
const PERKS = [
  ...
  { icon: '🌐', title: 'Global Network', body: "340+ certified operators across 6 continents. If there's an aircraft, Elevate will find it for you." },
  ...
  return (
    <div style={{ paddingTop: 72, minHeight: '100vh', background: 'var(--bg)' }}>
      <div className="page-hero">
        <div className="container">
          ...
          <p className="hero-sub" style={{ maxWidth: 600 }}>
            An Elevate Membership is your passport to the world's finest private aviation network.
            ...
            {TIERS.map(t => (
              ...
              >
                ...
                <button
                  ...
                  onClick={() => window.open('https://wa.me/971545297292?text=Hi%2C%20I%27m%20interested%20in%20the%20' + encodeURIComponent(t.name) + '%20membership%20with%20Elevate', '_blank')}
                >
                  Join {t.name.replace('Elevate ', '')} →
                </button>
              </div>
            ))}
          </div>
      ...
      <section className="section" style={{ background: 'white' }}>
        <div className="container">
          <div className="section-eyebrow">Why Members Love Elevate</div>
        ...
        <div className="container">
          ...
          <div className="faq-grid">
            {[
              ...
              { q: 'Is the concierge really 24/7?', a: 'Yes — Elevate operates from Dubai, London, and New York, covering all time zones. Premier and Infinite members have a direct line to a named concierge.' },
      ...
      <section className="page-cta-section">
        <div className="container" style={{ textAlign: 'center' }}>
          <h2 style={{ color: 'white', marginBottom: 16 }}>Ready to Join Elevate?</h2>
          ...
          <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
            <button
              ...
              onClick={() => window.open('https://wa.me/971545297292?text=Hi%2C%20I%27d%20like%20to%20learn%20more%20about%20Elevate%20Membership', '_blank')}
            >
